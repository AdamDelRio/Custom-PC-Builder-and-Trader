...
## 1. PC Build Templates (new and existing)

Creates a PC Build Template 

The API calls are made in this sequence when creating a PC template:
1. `Create PC Template`
2. `Get Existing PC Template`

### 1.1 Create PC Template - `/template/new/`

### 1.2 Get Existing PC Tempalte - `/template/existing/{template_id}`
