create table
  ...
  public.carts (
    ...
    constraint carts_user_id_fkey foreign key (user_id) references customers (id)
  ) tablespace pg_default;
  ...
  public.pc_template_parts (
    ...
    constraint pc_template_parts_user_id_fkey foreign key (user_id) references customers (id)
  ) tablespace pg_default;
  ...
  public.pc_templates (
    ...
    constraint pc_templates_user_id_fkey foreign key (user_id) references customers (id)
  ) tablespace pg_default;
  ...
  public.purchase_history (
    ...
    constraint purchase_history_user_id_fkey foreign key (user_id) references customers (id)
  ) tablespace pg_default;
